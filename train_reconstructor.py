...
def parse():
    ...
    parser.add_argument('-e', '--num-epochs', type=int, default=15, help='Number of epochs for reconstructor training')
    ...
    # Reconstructor specific parameters
    parser.add_argument('--cascade', type=int, default=5, help='Number of cascades')
    parser.add_argument('--chans', type=int, default=8, help='Number of channels for reconstruction U-Net')
    ...
    # SME model path (pre-trained)
    parser.add_argument('--sme-model-path', type=Path, default='../result/sme_model/checkpoints/best_sme_model.pt', 
                       help='Path to pre-trained SME model')
